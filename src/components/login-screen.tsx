...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 animate-in fade-in duration-1000 bg-background">
      <div className="absolute inset-0 bg-gradient-to-br from-background via-transparent to-background" />
      <Card className="w-full max-w-sm shadow-2xl bg-card/80 backdrop-blur-sm z-10 border-primary/20">
